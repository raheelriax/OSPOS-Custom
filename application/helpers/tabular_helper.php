...
function get_items_manage_table_headers()
{
	...
	$headers = array(
		...
		array('per_foot_price' => $CI->lang->line('items_per_foot_price')),
		array('quantity' => $CI->lang->line('items_quantity')),
		array('pipe_count' => $CI->lang->line('items_pipe_count')),
		array('weight_per_pipe' => $CI->lang->line('items_weight_per_pipe')),
...
function get_item_data_row($item)
{
	...
	return array (
		...
		'per_foot_price' => to_currency($item->per_foot_price),
		'quantity' => to_quantity_decimals($item->quantity),
		'pipe_count' => to_quantity_decimals($item->quantity)/20,
		'weight_per_pipe'=> to_quantity_decimals($item->weight_per_pipe),
