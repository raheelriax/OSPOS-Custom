...
<?php echo form_open('items/bulk_update/', array('id'=>'item_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="bulk_item_basic_info">
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('items_per_foot_price'), 'per_foot_price', array('class'=>'control-label col-xs-3')); ?>
			<div class='col-xs-4'>
				<div class="input-group input-group-sm">
					<?php if (!currency_side()): ?>
						<span class="input-group-addon input-sm"><b><?php echo $this->config->item('currency_symbol'); ?></b></span>
...
$(document).ready(function()
{
	...
	$('#item_form').validate($.extend({
		...
		messages:
		{
			...
			per_foot_price:
			{
				number: "<?php echo $this->lang->line('items_per_foot_price_number'); ?>"
			},
			weight_per_pipe:
			{
				number: "<?php echo $this->lang->line('items_per_foot_price_number'); ?>"
